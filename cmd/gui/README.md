...
| Task | What it does |
|---|---|
| `mise run gui:run:dev` | Vite plus the Go server with live reload, on http://localhost:5173 |
...
| `mise run browser` | drive the page in a headless Chrome and check the picker actually works (this spike is what it defaults to) |
